...
func (x *TranslateRequest) GetOriginText() string {
	if x != nil {
		return x.OriginText
	}
	return ""
...
type TranslateResponse struct {
	...
	TranslateResult string `protobuf:"bytes,2,opt,name=translateResult,proto3" json:"translateResult,omitempty"`
}
...
func (x *TranslateResponse) GetMsgCode() string {
	if x != nil {
		return x.MsgCode
	}
	return ""
...
func (x *TranslateResponse) GetTranslateResult() string {
	if x != nil {
...
var file_translate_proto_rawDesc = []byte{
	...
	,
...
var file_translate_proto_depIdxs = []int32{
	0, // 0: translate.test.Translate:input_type -> translate.TranslateRequest
	1, // 1: translate.test.Translate:output_type -> translate.TranslateResponse
...
func (c *testClient) Translate(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslateResponse, error) {
	out := new(TranslateResponse)
	err := c.cc.Invoke(ctx, "/translate.test/Translate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedTestServer) Translate(context.Context, *TranslateRequest) (*TranslateResponse, error) {
...
func _Test_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServer).Translate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/translate.test/Translate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).Translate(ctx, req.(*TranslateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Test_serviceDesc = grpc.ServiceDesc{
	ServiceName: "translate.test",
	HandlerType: (*TestServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Translate",
			Handler:    _Test_Translate_Handler,
		},
	},
